...
exec env WH_PROXY="$DAEMON_WH_PROXY" WH_PI_INGEST_BASE_URL="$WH_PI_INGEST_BASE_URL" WH_PI_RELAY_PORT="$WH_PI_RELAY_PORT" WH_PI_COMMAND="$WH_PI_COMMAND" python3 /worker_daemon.py
